...
namespace UniGLTF
{
    ...
    public struct UnityPath
    {
        ...
        {
            get { return System.IO.Path.GetFileNameWithoutExtension(Value); }
        }
        ...
        public UnityPath Parent
        {
            get
            {
                ...
                return new UnityPath(System.IO.Path.GetDirectoryName(Value));
            }
        }
        ...
        public static UnityPath FromUnityPath(string unityPath)
        {
            ...
            return FromFullpath(System.IO.Path.GetFullPath(unityPath));
        }
        #endregion
        ...
        static string BaseFullPath
        {
            get
            {
                ...
                {
                    s_basePath = System.IO.Path.GetFullPath(Application.dataPath + "/..").Replace("\\", "/");
                }
                return s_basePath;
            }
        }
        ...
        public string FullPath
        {
            get
            {
                ...
                return System.IO.Path.Combine(BaseFullPath, Value).Replace("\\", "/");
            }
        }
